...
const agregarProducto = async (req, res) =>{
    try {
        ...
        // agrego el objeto creado al array que generamos con el paseo
        ...
        res.status(400).send("no se puedo guardar el producto")
    }
}
...
const editarProducto = async (req, res) => {
    try {
        ...
        const posicion = id-1
        //colocar la informacion que va a actualziar la celda anterior
        ...
        await fs.promises.writeFile(`./db/product.json`,productJson);
        //devolvemos un resultado
        res.status(200).send("product editado");
    } catch {
...
const borrarTodo = async (req, res) => {
    try {
        ...
        await fs.promises.writeFile(`./db/product.json`,productJson);
        //devolvemos un resultado
        res.status(200).send("base basiada")
    } catch {
